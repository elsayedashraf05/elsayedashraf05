...
**Tech Stack**: `LabVIEW` `Real-Time Systems` `Data Acquisition`
...
**Alexandria University** | *Sep 2023 – Jun 2028 (Expected)* |
...
const currentProjects = {
    learning: "DEPI Microsoft Azure cloud data engineering Track",
